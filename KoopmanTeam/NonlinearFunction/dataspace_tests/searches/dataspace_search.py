...
generated by the write)history and append_history functions found in utils.py.
...
TIMERANGE = 20
MAXEVOLVE = 50000
BATCH_SIZE = 100000 #100000 points on bloch fit in ~2GB VRAM, FSC has ~12GB
...
if MEMFIT:
    ...
    num_files = 50000
    dataset = '0t{}_{}inits_dt{}_compressed_TFRecord/'.format(TIMERANGE,num_files,str(TIMESTEP).replace('.','p'))
