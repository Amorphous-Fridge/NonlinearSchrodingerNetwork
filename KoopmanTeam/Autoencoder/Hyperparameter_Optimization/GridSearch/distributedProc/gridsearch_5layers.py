        ...
        for i1 in range(0,i2):
            for i4 in range(0,i3):
                for i5 in range(0,i4):
                    ...
                    widths.append((nn[i1],nn[i2],nn[i3],nn[i4],nn[i5])) #TODO:change num inputs

(width1,width2,width3,width4,width5) = widths[modelnum] #TODO: change # outputs
...
#SAVE TO A FILE
write_history(history, [Autoencoder, Phi, Phi_inv], datadir='./Results5L/', batch_size='4096',modelnum=str(modelnum)) #TODO:change datadir
